...
public class VentanaPrincipal extends JFrame implements ActionListener,ChangeListener {
	...
	private void iniciarComponentes() {
                /*instanciamos el contenedor con esto definmos nosotros mismos los tama�os y posicion de los componentes*/
	...
	/**permite validar cuando se selecciona un check un radioButton, una opci�n del combo o se presiona el ToogleButton y se */
